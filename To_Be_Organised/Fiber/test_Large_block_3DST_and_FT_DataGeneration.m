%% LargeBlock_FAST version - With Saving only the final VV_FiberTracks
tic;
clear;close all;clc;
...
% Perform ST Analysis
[coh,EV,VectorF]=testStructureFiber3D3(InvV1,Jxx, Jxy, Jxz, Jyy, Jyz, Jzz,parametersDTI);
...
[~,~,r,~]=size(rgb_y);
cd /hpc_atog/btho733/ABI/JZ/Fiber_DTI/Large_block_25um_filtered/a303_ST3D_results_EVLargest/s1m3rho5k25/;
for i=1:r
...
%     cd negzy/;imwrite(plane_x,namex);cd ..;
%     cd negzx;imwrite(plane_y,namey);cd ..;
%     cd negyx;imwrite(plane_z,namez);cd ..;
