function [x3,y3]=BestEdgeNeighbor(coords,sob,angu,gr1,actual_angle,ang1)
...
angleAtcoords=diag(ang1(y,x));
diff=abs(actual_angle-angleAtcoords);
check4(diff<40)=1;
result=2*check1+check2+5*check3+5*check4;
